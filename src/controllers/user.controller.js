...
const generateAccessAndRefreshTokens = async(userId) => {
    try {
        ...
        throw new ApiError(500, "Something went while generating refreshing and access token")
    }
}
...
const loginUser = asyncHandler( async (req, res) => {
    ...
    // find the user
    // password check
    // if correct -> access and refresh token
    // send cookies
    ...
    //  this is if we want to take both of them
    if(!username && !email){
         throw new ApiError(400, "username or email is required")
    }
